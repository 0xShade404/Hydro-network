 ...
 *
 * Tests redeem notes for real HydroToken, copied in the same way
 * contracts/staking copies it. See contracts/staking/scripts/compile.ts.
 */

const RWA_DIR = path.join(__dirname, "..");
const CONTRACTS_DIR = path.join(RWA_DIR, "contracts");
const ARTIFACTS_DIR = path.join(RWA_DIR, "artifacts");
const HYDRO_TOKEN_SOURCE_PATH = path.join(RWA_DIR, "..", "..", "contracts", "token", "contracts", "HydroToken.sol");
